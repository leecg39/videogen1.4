...
- **2026-04-19 R11 v1.4 전면 재작성** — DSL 기본값 공식 철회. TSX 기본값 (`src/remotion/custom/scene-NN.tsx`) + 원칙 B adapter (`_dsl.tsx`) + DSL 3조건 strict + AST validator 체인 (⓪-tsx1~3) 명문화. pattern builder / realize 섹션 전부 제거. 참고: `docs/handoff-2026-04-20-next-skill-sync.md` + `.Codex/rules/scene-grammar.md` v1.4.
